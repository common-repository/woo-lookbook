...
class WOO_LOOKBOOK_Elementor_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'WC Lookbooks', 'woo-lookbook' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'general',
			[
				'label' => esc_html__( 'General', 'woo-lookbook' ),
		...
		$this->add_control(
			'shortcode_type',
			[
				'label'       => esc_html__( 'Select shortcode type', 'woo-lookbook' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'label_block' => true,
				'default'     => 'single',
				'options'     => [
					'single'    => esc_html__( 'Single', 'woo-lookbook' ),
					'multiple'  => esc_html__( 'Carousel/Gallery', 'woo-lookbook' ),
		...
		$this->add_control(
			'shortcode_id',
			[
				'label'       => esc_html__( 'Select id', 'woo-lookbook' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'label_block' => true,
		...
		$this->add_control(
			'shortcode_ids',
			[
				'label'       => esc_html__( 'Select ids', 'woo-lookbook' ),
		...
		$this->add_control(
			'layout',
			[
				'label'       => esc_html__( 'Layout', 'woo-lookbook' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'label_block' => true,
				'default'     => 'carousel',
				'options'     => [
					'carousel' => esc_html__( 'Carousel', 'woo-lookbook' ),
					'gallery'  => esc_html__( 'Gallery', 'woo-lookbook' )
				],
				'condition'   => [ 'shortcode_type' => 'multiple' ]
			]
		);
	...
	public function render_plain_content() {
		echo wp_kses_post( $this->raw_render() );
	}
