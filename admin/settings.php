...
class WOO_F_LOOKBOOK_Admin_Settings {
	...
	public function save_meta_boxes() {
		...
		if ( ! wp_verify_nonce( sanitize_key( wp_unslash( $_POST['_woo_lookbook_nonce'] ) ), 'woo_lookbook_settings' ) ) {
			return false;
		}
		if ( ! current_user_can( 'manage_options' ) ) {
			return false;
		}
		$data = wc_clean( wp_unslash( $_POST['woo_lookbook_params'] ) );
		if ( is_array( $data ) ) {
            ...
            <form method="post" action="" class="vi-ui form">
                ...
                <div class="vi-ui bottom attached tab segment" data-tab="product">
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'link_redirect' ) ); ?>">
									<?php esc_html_e( 'Link Redirect', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <div class="vi-ui toggle checkbox">
                                    <input id="<?php echo esc_attr( self::set_field( 'link_redirect' ) ); ?>"
                                           type="checkbox" <?php checked( self::get_field( 'link_redirect' ), 1 ) ?>
                                           tabindex="0" class="hidden" value="1"
                                           name="<?php echo esc_attr( self::set_field( 'link_redirect' ) ); ?>"/>
                                    <label></label>
                                </div>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'external_product' ) ); ?>">
									<?php esc_html_e( 'External Link', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <div class="vi-ui toggle checkbox">
                                    <input id="<?php echo esc_attr( self::set_field( 'external_product' ) ); ?>"
                                           type="checkbox" <?php checked( self::get_field( 'external_product' ), 1 ) ?>
                                           tabindex="0" class="hidden" value="1"
                                           name="<?php echo esc_attr( self::set_field( 'external_product' ) ); ?>"/>
                                    <label></label>
                                </div>
                ...
                <div class="vi-ui bottom attached tab segment" data-tab="design">
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'icon' ) ); ?>">
									<?php esc_html_e( 'Icon', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <a class="vi-ui wlb-add-new button blue button-primary"
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input type="text" class="color-picker"
                                       ...
                                       value="<?php echo esc_attr( self::get_field( 'icon_color', '#fff' ) ); ?>"
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input type="text" class="color-picker"
                                       ...
                                       value="<?php echo esc_attr( self::get_field( 'icon_background_color', '#E8CE40' ) ); ?>"
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input type="text" class="color-picker"
                                       ...
                                       value="<?php echo esc_attr( self::get_field( 'icon_border_color', '#E8CE40' ) ); ?>"
                                       style="background-color: <?php echo esc_attr( self::get_field( 'icon_border_color', '#E8CE40' ) ) ?>"/>
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'hide_title' ) ); ?>">
									<?php esc_html_e( 'Hide Title', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <div class="vi-ui toggle checkbox">
                                    <input id="<?php echo esc_attr( self::set_field( 'hide_title' ) ) ?>"
                                           type="checkbox" <?php checked( self::get_field( 'hide_title' ), 1 ) ?>
                                           tabindex="0"
                                           class="hidden" value="1"
                                           name="<?php echo esc_attr( self::set_field( 'hide_title' ) ); ?>"/>
                                    <label></label>
                                </div>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input type="text" class="color-picker"
                                       ...
                                       value="<?php echo esc_attr( self::get_field( 'title_color', '#212121' ) ); ?>"
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input type="text" class="color-picker"
                                       ...
                                       value="<?php echo esc_attr( self::get_field( 'title_background_color', '#eee' ) ); ?>"
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'loading_icon' ) ); ?>">
									<?php esc_html_e( 'Loading Icon', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <a class="vi-ui wlb-add-new button blue button-primary" target="_blank"
                                   href="https://1.envato.market/mV0bM">
									<?php esc_html_e( 'Update this feature', 'woo-lookbook' ) ?>
                                </a>
                            </td>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input type="text" class="color-picker"
                                       ...
                                       value="<?php echo esc_attr( self::get_field( 'text_color', '#E8CE40' ) ); ?>"
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input type="text" class="color-picker"
                                       ...
                                       value="<?php echo esc_attr( self::get_field( 'background_color', '#fff' ) ); ?>"
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'close_button' ) ); ?>">
									<?php esc_html_e( 'Hide Close Button', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <div class="vi-ui toggle checkbox">
                                    <input id="<?php echo esc_attr( self::set_field( 'close_button' ) ); ?>"
                                           type="checkbox" <?php checked( self::get_field( 'close_button' ), 1 ) ?>
                                           tabindex="0" class="hidden" value="1"
                                           name="<?php echo esc_attr( self::set_field( 'close_button' ) ); ?>"/>
                                    <label></label>
                                </div>
                                <p class="description"></p>
                            </td>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'see_more' ) ); ?>">
									<?php esc_html_e( 'Hide See More Button', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <div class="vi-ui toggle checkbox">
                                    <input id="<?php echo esc_attr( self::set_field( 'see_more' ) ); ?>"
                                           type="checkbox" <?php checked( self::get_field( 'see_more' ), 1 ) ?>
                                           tabindex="0"
                                           class="hidden" value="1"
                                           name="<?php echo esc_attr( self::set_field( 'see_more' ) ); ?>"/>
                                    <label></label>
                                </div>
                                <p class="description"></p>
                            </td>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'rtl' ) ); ?>">
                    ...
                    <table class="optiontable form-table">
                                ...
                                <div class="vi-ui form">
                                    <div class="inline fields">
                                        <input type="number"
                                               ...
                                               value="<?php echo esc_attr( self::get_field( 'slide_width', 1170 ) ); ?>"/>
                                        <label><?php esc_html_e( 'px', 'woo-lookbook' ) ?></label>
                                    </div>
                                </div>
                            </td>
                                ...
                                <div class="vi-ui form">
                                    <div class="inline fields">
                                        <input type="number"
                                               ...
                                               value="<?php echo esc_attr( self::get_field( 'slide_height', 600 ) ); ?>"/>
                                        <label><?php esc_html_e( 'px', 'woo-lookbook' ) ?></label>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'slide_effect' ) ); ?>">
									<?php esc_html_e( 'Effect', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <select name="<?php echo esc_attr( self::set_field( 'slide_effect' ) ); ?>"
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'slide_pagination' ) ); ?>">
									<?php esc_html_e( 'Slide Pagination', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <div class="vi-ui toggle checkbox">
                                    <input id="<?php echo esc_attr( self::set_field( 'slide_pagination' ) ); ?>"
                                           type="checkbox" <?php checked( self::get_field( 'slide_pagination' ), 1 ) ?>
                                           tabindex="0" class="hidden" value="1"
                                           name="<?php echo esc_attr( self::set_field( 'slide_pagination' ) ); ?>"/>
                                    <label></label>
                                </div>
                                <p class="description"></p>
                            </td>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'slide_navigation' ) ); ?>">
									<?php esc_html_e( 'Slide Navigation', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <div class="vi-ui toggle checkbox">
                                    <input id="<?php echo esc_attr( self::set_field( 'slide_navigation' ) ); ?>"
                                           type="checkbox" <?php checked( self::get_field( 'slide_navigation' ), 1 ) ?>
                                           tabindex="0" class="hidden" value="1"
                                           name="<?php echo esc_attr( self::set_field( 'slide_navigation' ) ); ?>"/>
                                    <label></label>
                                </div>
                                <p class="description"></p>
                            </td>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'slide_auto_play' ) ); ?>">
									<?php esc_html_e( 'Auto play', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <div class="vi-ui toggle checkbox">
                                    <input id="<?php echo esc_attr( self::set_field( 'slide_auto_play' ) ); ?>"
                                           type="checkbox" <?php checked( self::get_field( 'slide_auto_play' ), 1 ) ?>
                                           tabindex="0" class="hidden" value="1"
                                           name="<?php echo esc_attr( self::set_field( 'slide_auto_play' ) ); ?>"/>
                                    <label></label>
                                </div>
                                <p class="description"></p>
                            </td>
                                ...
                                <div class="vi-ui form">
                                    <div class="inline fields">
                                        <input type="number"
                                               ...
                                               value="<?php echo esc_attr( self::get_field( 'slide_time', 5000 ) ); ?>"/>
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <textarea type="text"
                                          name="<?php echo esc_attr( self::set_field( 'custom_css' ) ); ?>"><?php echo esc_attr( self::get_field( 'custom_css' ) ); ?></textarea>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                ...
                <div class="vi-ui bottom attached tab segment" data-tab="instagram">
                    ...
                    <ul>
                        ...
                        <li>
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/109jLhPIokY"
                                    frameborder="0"
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'ins_client_id' ) ); ?>">
									<?php esc_html_e( 'Client ID', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <input type="text" name="<?php echo esc_attr( self::set_field( 'ins_client_id' ) ); ?>"
                                       value="<?php echo esc_attr( self::get_field( 'ins_client_id', '' ) ); ?>"/>

                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'ins_client_secret' ) ); ?>">
									<?php esc_html_e( 'Client Secret', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <input type="text"
                                       name="<?php echo esc_attr( self::set_field( 'ins_client_secret' ) ); ?>"
                                       value="<?php echo esc_attr( self::get_field( 'ins_client_secret', '' ) ); ?>"/>
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'ins_access_token' ) ); ?>">
									<?php esc_html_e( 'Access Token', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <input type="hidden" name="<?php echo esc_attr( self::set_field( 'ins_page_id' ) ); ?>"
                                       value="<?php echo esc_attr( self::get_field( 'ins_page_id', '' ) ); ?>"/>
                                <input type="text"
                                       name="<?php echo esc_attr( self::set_field( 'ins_access_token' ) ); ?>"
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'ins_display' ) ); ?>">
									<?php esc_html_e( 'Display', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <select name="<?php echo esc_attr( self::set_field( 'ins_display' ) ); ?>"
                                        class="vi-ui fluid dropdown">
                                    <option <?php selected( self::get_field( 'ins_display' ), 0 ) ?>
                                            value="0"><?php esc_attr_e( 'Gallery', 'woo-lookbook' ) ?></option>
                                    <option <?php selected( self::get_field( 'ins_display' ), 1 ) ?>
                                            value="1"><?php esc_attr_e( 'Carousel', 'woo-lookbook' ) ?></option>
                                </select>
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input type="number"
                                       ...
                                       value="<?php echo esc_attr( self::get_field( 'ins_display_limit', 12 ) ); ?>"/>
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'ins_link' ) ); ?>">
									<?php esc_html_e( 'Link to Instagram', 'woo-lookbook' ) ?>
                                </label>
                            </th>
                            <td>
                                <div class="vi-ui toggle checkbox">
                                    <input id="<?php echo esc_attr( self::set_field( 'ins_link' ) ); ?>"
                                           type="checkbox" <?php checked( self::get_field( 'ins_link' ), 1 ) ?>
                                           tabindex="0"
                                           class="hidden" value="1"
                                           name="<?php echo esc_attr( self::set_field( 'ins_link' ) ); ?>"/>
                                    <label></label>
                                </div>
                            </td>
                        </tr>
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'ins_schedule' ) ); ?>">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'ins_image_status' ) ); ?>">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'ins_duplicate' ) ); ?>">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'ins_image_quantity' ) ); ?>">
