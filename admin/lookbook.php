...
class WOO_F_LOOKBOOK_Admin_Lookbook {
	...
	public function product_scripts() {
		...
		if ( 'woocommerce-lookbook' == $screen->id ) {
			wp_enqueue_style( 'woo-lookbook-button', WOO_F_LOOKBOOK_CSS . 'button.min.css', array(), '2.2.12' );
			wp_enqueue_style( 'woo-lookbook-admin-metabox', WOO_F_LOOKBOOK_CSS . 'woo-lookbook-admin-metabox' . $this->suffix . '.css', array(), WOO_F_LOOKBOOK_VERSION );
			wp_enqueue_style( 'select2', WOO_F_LOOKBOOK_CSS . 'select2.min.css', array(), '4.0.5' );

			wp_enqueue_media();
			wp_enqueue_script( 'jquery-ui-draggable' );
			wp_enqueue_script( 'select2', WOO_F_LOOKBOOK_JS . 'select2.min.js', array( 'jquery' ), '4.0.5', false );
			wp_enqueue_script( 'woo-lookbook-admin-metabox', WOO_F_LOOKBOOK_JS . 'woo-lookbook-admin-metabox' . $this->suffix . '.js', array( 'jquery' ), WOO_F_LOOKBOOK_VERSION, true );
		...
		if ( 'edit-woocommerce-lookbook' == $screen->id ) {
			...
			wp_enqueue_style( 'woo-lookbook-edit', WOO_F_LOOKBOOK_CSS . 'woo-lookbook-admin-lookbook' . $this->suffix . '.css', array(), WOO_F_LOOKBOOK_VERSION );


			wp_enqueue_script( 'woo-lookbook-admin-lookbook', WOO_F_LOOKBOOK_JS . 'woo-lookbook-admin-lookbook' . $this->suffix . '.js', array( 'jquery' ), WOO_F_LOOKBOOK_VERSION, true );
	...
	public function save_metabox( $post_id, $post ) {
		// Add nonce for security and authentication.
		$nonce_name   = isset( $_POST['_wlb_nonce'] ) ? sanitize_key( wp_unslash( $_POST['_wlb_nonce'] ) ) : '';
